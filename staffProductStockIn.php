                    ...
                    <div class="justify-self-start w-full bg-[#eaf8ff] px-5 rounded-bl-lg grid grid-cols-2">
                        ...
                        <div class="flex justify-center grid grid-rows-2">
                            <div class="pt-10">
                                ...
                                <p><b>Stocks on Hand:</b> <?= $product['product_quantity']?> </p>
                            </div>
                            <div class="pt-10">
                                <form method="post" action="staffProductStockIn.php">
                                    <div class="grid grid-rows-2 flex justify-center">
                                        <div>
                                            <label class="text-sm"><b>Stock in Quantity: </b></label>
                                        ...
                                        <div>
                                            ...
                                            <button type="submit" class="w-64 rounded-full text-md text-white bg-[#5094c8] rounded-md hover:bg-[#eaf8ff] hover:text-[#2986CC] mt-2 p-2" name="addStock">
                                                Add STOCKS
                                            </button>
                                        </div>
                                    </div>
