            ...
            <div class="bg-[#FCE4BE] rounded-3xl flex flex-col w-full h-full px-10 py-10">
                <div>
                    <div class="grid grid-cols-2">
                        <p class="text-4xl font-extrabold w-full px-3 text-[#221E3F] pb-4">AVAILABLE PRODUCTS</p>
                        <div class="flex justify-end">
                            <a href="staffInStoreTransaction.php"><button class="flex w-48 h-[40px] text-md text-white rounded-full bg-[#221E3F] pl-12 text-white hover:bg-[#6257b4] pt-2">Back to Cart</button></a>
                        </div>
                    </div>
                                                    ...
                                                    <?php if ($product) { ?>
                                                        <?php foreach($product as $products): ?>
                                                                <tr class="cursor-pointer hover:bg-[#e8d2ae]">
                                                                    ...
                                                                    <td><a href='staffProduct.php?productID=<?= $products['product_id'];?>'><button class="ml-1 rounded-lg bg-[#221E3F] px-4 text-white hover:bg-[#6257b4] text-white p-2 text-sm">Add to Cart</button></a></td>
                                                                </tr>
                                                        <?php endforeach; ?>
                                                    <?php } else { ?>
                                                        <tr>
