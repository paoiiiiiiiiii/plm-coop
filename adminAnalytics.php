	...
	<body class="bg-[#221E3F]">    	
        <div class="w-full h-full flex">
            ...
            <div class="w-full h-auto px-10 py-5">
                ...
                <div>
                    <p class="text-4xl font-extrabold w-full px-3 text-[#221E3F]">Analytics</p>
                            ...
                            <div class="bg-white flex flex-col w-full">
                                <div>
                                    <div class="grid grid-cols-3">
                                        ...
                                        <div class="flex-1 text-[#221E3F] rounded-md h-[8rem] p-2 rid grid-cols-3 col-span-3 items-center">
                                            <div class="col-span-2 text-lg pr-3 pt-1 pl-4">
                                                <ul class="text-lg font-semibold text-left"><b>Average Daily Sale</b></ul> 
                                                <ul class="text-4xl text-left">₱ <?= $averageDailySale ?></ul> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-1 text-[#221E3F] rounded-md h-[8rem] p-2 grid grid-cols-3 col-span-3">
                                            <div class="col-span-2 text-lg pr-5 pt-1 pl-4">
                                                <ul class="text-lg font-semibold text-left"><b>Monthly Sale</b></ul> 
                                                <ul class="text-4xl text-left">₱ <?= $monthlySale ?></ul> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-1 text-[#221E3F] rounded-md h-[8rem] p-2 grid grid-cols-3 col-span-3">
                                            <div class="col-span-2 text-lg pt-1 pl-4">
                                                <ul class="text-lg font-semibold text-left"><b>Yearly Sale</b></ul> 
                                                <ul class="text-4xl text-left">₱ <?= $yearlySale ?></ul> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white mt-5 rounded-2xl py-5 px-5 drop-shadow-xl">
                        <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F]">TOP SELLING ITEMS</p>
                        <div class="flex">
                        ...
                        <div class="flex my-5">
                            <div class="bg-white flex flex-col w-full h-[42rem]">
                                <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F]">TOTAL SALES PER ITEM</p>
