...
$product = $coop->getStaffTransactionProducts();
$transaction = $coop->getStaffTransactionDetails();
    ...
    <body class="px-10">    	
        <div>
            <div class="flex">
                ...
                <a href="staffTransactionHistory.php"><button class="ml-10 mt-5 rounded-lg bg-[#67b0e7] text-white hover:bg-[#2986CC] p-1 text-sm">Back</button></a>
            </div>
            ...
            <div class="mx-10 mb-4">
                <p><b>Date & Time: </b><?= $transaction['date'] ?></p>
                <p><b>Cashier ID: </b><?= $transaction['cashier_name']?></p>
            </div>
            ...
            <div class="mb-5 mx-10 text-left">
                ...
                <table class="w-96">
                    ...
                    <tr>
                        ...
                        <td><p class="flex-auto text-lg"><?= $transaction['process'] ?>
                        <?php if ($transaction['process'] == 'delivery' OR $transaction['process'] == 'walkin')  {?>
                            <p>ONLINE PURCHASE</p>
                        <?php } else { ?>
                            <p>IN STORE PURCHASE</p>
                        <?php } ?>
                        </td>
                    </tr>
                ...
                <?php } else { ?>
                    <table class="w-96">
                        <tr>
                            <td><p class="flex-auto text-lg"><b>Name of Customer</b> </td>
                            <td><p class="flex-auto text-lg"><?= $transaction['name'] ?></td>
                        </tr>
