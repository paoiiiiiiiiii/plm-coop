...
$soldItems = $coop->getYearlySoldItems();

//chart data
$topSelling = $coop->getYearlyTopSelling();
$yearlySalesChartData = $coop->getYearlyChartSales();

$totalProductSold = $coop->getTotalProductsYearly();
$totalYearlyTransactions = $coop->getTotalTransactionsYearly();
$yearlyTransaction = $coop->getYearlyTransactions();
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php foreach ($yearlySalesChartData as $sale): ?>
	...
	<body class="bg-[#221E3F]">    	
        <div class="w-full h-full flex">
            ...
            <div class="w-full h-auto px-10 py-5">
                ...
                <div>
                    <div class="flex">
                        <p class="text-4xl font-extrabold w-full px-3 text-[#221E3F]">Analytics - YEARLY</p>
                        <div class="justify-end mx-1 w-full flex items-center">
                            ...
                            <a href="adminAnalyticsYearly.php"><p class="text-xs ml-3 text-[#2986CC] font-bold outline outline-offset-1 outline-[#221E3F] rounded-md bg-[#43365E] p-2 text-white">YEARLY</p></a>
                        </div>
                    </div>

                    <div class="m-auto mt-5">
                        <form method='get' action='adminAnalyticsYearly.php'>
                            <label class="ml-2 text-md text-[#221E3F] font-bold mt-2">Date</label>
                            <input type="number" name="year" min="2000" max="<?= $presentYear ?>" class="ml-2 outline outline-offset-2 outline-[#221E3F] rounded-md w-32" required value="<?= $year ?>"></input>
                    ...
                    <div class="bg-white mt-5 rounded-2xl py-5 px-5 drop-shadow-xl">
                        <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F] mb-10">SALES SUMMARY  (<?= $year ?>)</p>
                        <div class="flex">
                                    ...
                                    <div class="grid grid-cols-3">
                                        ...
                                        <div class="flex-1 text-[#221E3F] rounded-md h-[8rem] p-2 grid-cols-3 col-span-3 items-center">
                                            <div class="col-span-3 text-lg pr-3 pt-1">
                                                ...
                                                <ul class="text-5xl text-center font-bold mt-3">₱ <?= $totalYearlySale['total'] ?></ul> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-1 text-[#221E3F] rounded-md h-[8rem] p-2 grid grid-cols-3 col-span-3">
                                            <div class="col-span-3 text-lg pr-3 pt-1">
                                                ...
                                                <ul class="text-5xl text-center font-bold mt-3"><?= $totalYearlyTransactions ?></ul> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white mt-5 rounded-2xl py-5 px-5 drop-shadow-xl">
                        ...
                        <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F] mb-5">TRANSACTIONS MADE (<?= $year ?>)</p>
                        ...
                        <div class="w-full flex h-[36rem] bg-[#FCE4BE] rounded-lg mt-5"> 
                            <div class="justify-self-start w-full overflow-auto max-h-106 bg-white rounded-lg">
                                ...
                                <?php foreach($yearlyTransaction as $transactions): ?>
                    ...
                    <div class="bg-white mt-5 rounded-2xl py-5 px-5 drop-shadow-xl">
                        ...
                        <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F] mb-10">TOP SELLING  (<?= $year ?>)</p>
                        ...
                        <div class="flex my-5">
                            <div class="bg-white flex flex-col w-full h-[42rem]">
                                <p class="text-2xl font-extrabold w-full px-3 text-[#221E3F]">TOTAL SALES PER ITEM  (<?= $year ?>)</p>
