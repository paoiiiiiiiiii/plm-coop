                ...
                <div class="bg-[#FCE4BE] rounded-3xl flex flex-col w-full h-full px-10 py-10">
                    <div>
                        ...
                        <div class="grid grid-cols-3 mt-5">
                            <div class="flex-1 bg-[#1bcb00] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center"><img src="static/icons/sales.png" width="90" height="90"></div>
                            ...
                            <div class="flex-1 bg-[#00b9e5] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center pl-3"><img src="static/icons/products.png" width="85" height="85"></div>
                                <div class="col-span-2">
                            ...
                            <div class="flex-1 bg-[#f8de00] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center pl-3"><img src="static/icons/stocks.png" width="90" height="90"></div>
                                <div class="col-span-2">
                            ...
                            <div class="flex-1 bg-[#ff6363] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center pl-3"><img src="static/icons/criticals.png" width="80" height="80"></div>
                                <div class="col-span-2">
                            ...
                            <div class="flex-1 bg-[#FFA15E] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center pl-3"><img src="static/icons/customers.png" width="90" height="90"></div>
                                <div class="col-span-2">
                            ...
                            <div class="flex-1 bg-[#DE53C8] text-[#221E3F] rounded-3xl h-[10rem] mx-3 my-5 p-2 grid grid-cols-3 drop-shadow-xl items-center"><div class="col-span-1 flex items-center justify-center pl-3"><img src="static/icons/transactions.png" width="90" height="90"></div>
