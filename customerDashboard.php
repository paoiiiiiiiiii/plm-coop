            ...
            <div class="rounded-md py-5 px-20 pb-5 drop-shadow-md">
                ...
                <div class="w-100% flex h-auto mt-8">
                    <div class="justify-self-start w-full bg-[#eaf8ff] px-5 rounded-bl-lg pt-10">
                        <h1 class="text-center text-5xl font-bold">PRODUCT CATEGORIES</h1>

                        <div class="grid grid-cols-4 px-5 py-5">
                            <?php if($category){ ?>
                                    <?php foreach($category as $categories): ?>
                                        <a href="customerProducts.php?categoryID=<?= $categories['category_id']?>">
                                            <div class="h-48 mx-2 my-2 bg-white rounded-md flex items-center justify-center cursor-pointer">
                                                <img src="thumbnails/<?= $categories['thumbnail'];?>" width="50" height="50">    
